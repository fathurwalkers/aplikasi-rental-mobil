<div>
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown">
              <a href="#" class="nav-link has-dropdown"><i class="far fa-file-alt"></i> <span>Kelola Pengguna</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="forms-advanced-form.html">Daftar Pengguna</a></li>
                <li><a class="nav-link" href="forms-validation.html">Informasi</a></li>
              </ul>
            </li>
